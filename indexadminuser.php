...
$jumlahData = count(query("SELECT * FROM foruser"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;

$user = query("SELECT * FROM foruser LIMIT $awalData, $jumlahDataPerHalaman");
...
<html>
<head>
	<link rel="stylesheet" href="./indexadminuser.css">
...
<section id="conten">
          ...
          <div class="order">
            ...
            <thead class="thead">
                <tr class="truser">
                  ...
                  <th class="usn">Username</th>
                  <th class="eml">Email</th>
                  <th class="wa">Whatsapp</th>
	...
	<tr class="tr">
		<td class="nom2"><?= $i; ?></td>
        <td class="name2"><?= $row["name"]; ?></td>
        <td class="usn2"><?= $row["username"]; ?></td>
        <td class="email2"><?= $row["email"]; ?></td>
        <td class="wa2"><?= $row["whatsapp"]; ?></td>
		<td class="actn2">
			
			<a href="hapususer.php?id=<?= $row["id_user"]; ?>" onclick="return confirm('yakin?');"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M6 7H5v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7H6zm4 12H8v-9h2v9zm6 0h-2v-9h2v9zm.618-15L15 2H9L7.382 4H3v2h18V4z"></path></svg></a>
		</td>
